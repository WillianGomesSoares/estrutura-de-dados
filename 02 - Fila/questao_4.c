...
int Desenfileirar( struct Fila *f ) { // pega o item do comeÃ§o da fila
...
int FilaVazia( struct Fila *f ) { // retorna verdadeiro se a fila estÃ¡ vazia

	return (f->nItens==0);

}

int FilaCheia( struct Fila *f ) { // retorna verdadeiro se a fila estÃ¡ cheia
